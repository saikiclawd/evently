    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-amber-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-accent to-blue-700 flex items-center justify-center">
            <Zap size={24} className="text-white" />
          </div>
          <div>
            <div className="text-2xl font-extrabold text-gray-900 tracking-tight">Evently</div>
            <div className="text-xs font-semibold text-gray-400 tracking-[0.2em]">PRO</div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isRegister && (
              <>
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-sm text-gray-800 placeholder-gray-500 focus:outline-none focus:border-accent transition-colors"
                  required
                />
                <input
            ...
            <button
              ...
              className="w-full py-3 rounded-lg bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 transition-colors disabled:opacity-50"
            >
